...
export const Hero = () => {
  ...
  return (
    ...
    <div
      className={`flex w-full flex-col justify-center items-start h-[90vh] md:h-[90vh] bg-hero-img bg-cover bg-bottom bg-no-repeat z-10 xl:bg-center`}
    >
        ...
        <div className="flex flex-col">
          <div className="text-center flex flex-col justify-center items-center">
            <h1 className="text-offwhite  text-4xl lg:text-6xl uppercase font-medium tracking-kd-wide font-bookletter md:text-5xl">
              {/* <h1 className="text-offwhite  text-4xl lg:text-6xl uppercase font-medium tracking-kd-wide font-cowboy md:text-5xl"> */}
              {/* <h1 className='text-offwhite  text-4xl lg:text-6xl uppercase font-medium tracking-kd-wide font-ranch md:text-5xl'> */}
              Karlson <br /> Drendel
            </h1>
            <br />
            <h1 className="text-[#c9c7c7] md:text-xl uppercase font-thin tracking-kd-wide">
              <Typed strings={typedText} typeSpeed={100} backSpeed={80} loop />
            </h1>
          </div>
          <div className="flex justify-center mt-2 pt-5 space-x-4 md:space-x-6 text-2xl items-center text-grey">
            <a
              className="w-[18px]"
              href="https://github.com/kdrendel99"
              target="__blank"
            >
            ...
            <a
              className="w-[18px]"
              href="https://twitter.com/karlsondrendel"
              target="__blank"
            >
            ...
            <a
              className="w-[18px]"
              href="https://www.linkedin.com/in/karlson-drendel/"
              target="__blank"
            >
