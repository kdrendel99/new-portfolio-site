...
export const Separator = () => {
  return (
    // <div className='flex py-20 flex-col justify-center items-center w-full px-20 dark:bg-mutedBlack'>
    // </div>
    ...
    <div className="flex w-full justify-center items-center -mb-1">
      ...
      <div
        className={`${styles.separator} flex dark:hidden w-full h-[100px] relative`}
      ></div>
      <div
        className={`${styles.separatorDark} dark:flex hidden w-full h-[100px] relative`}
      ></div>
    </div>
  );
};
